  ...
  return (
    <div id="sobre" className="h-dvh flex flex-col justify-center items-center">
      <div className="mt-20 flex flex-col items-start gap-4 text-center">
        <h2 className="font-bold text-[22px] w-2/3 mx-auto font-[tan] md:text=[24px]">{textos.cta}</h2>
        <div className="mt-4 flex flex-col gap-4 text-[16px] w-9/10 mx-auto md:w-1/2 lg:text-[18px]">
          <p>{textos.texto}</p>
        </div>
        <Sparkles className="size-15 mx-auto mt-6" />
